...
setup(
    ...
    install_requires=[
        ...
        'mapzen.whosonfirst.geojson>=0.05',
    ...
    dependency_links=[
        ...
        'https://github.com/whosonfirst/py-mapzen-whosonfirst-geojson/tarball/master#egg=mapzen.whosonfirst.geojson-0.05',
    ...
    download_url='https://github.com/mapzen/py-mapzen-whosonfirst-export/releases/tag/v0.67',
    license='BSD')
